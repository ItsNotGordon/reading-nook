/**
 * Reading Nook canonical genre vocabulary for book provider subject mapping.
 * Display labels are title-case; matching uses {@link segmentKey}.
 */

/** User-facing genre labels. */
...
const SEGMENT_ENTRIES: readonly SegmentEntry[] = [
  ...
  ["chick lit", "Chick lit"],
  ["chic lit", "Chick lit"],
  // Google Books category segments
  ["fantasy and magic", "Fantasy"],
  ["self help", "Self-help"],
  ["body mind and spirit", "Self-help"],
  ...
  ["language arts and disciplines", "Non-fiction"],
  ["literary criticism", "Non-fiction"],
  ["literary collections", "Fiction"],
  ["family and relationships", "Family fiction"],
  ["games and activities", "Non-fiction"],
  ["crafts and hobbies", "Non-fiction"],
  ["pets", "Non-fiction"],
  ["gardening", "Non-fiction"],
  ["house and home", "Non-fiction"],
  ["transportation", "Non-fiction"],
  ["antiques and collectibles", "Non-fiction"],
  // Legacy OL phrase patterns
